...
novelRouter.get('/api/chapter/desc/getAll',verifyToken,novelController.getAllDescChapter)

novelRouter.put('/api/novel/updateStatus',verifyToken,novelController.updateStatus)
